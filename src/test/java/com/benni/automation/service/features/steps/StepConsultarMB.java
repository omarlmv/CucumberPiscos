...
/*
	...
	public void la_se_encuentra(String tarjeta, String estado) throws Throwable {
		...
		headerRiesgo.put("SOAPAction",
				"http://interbank.com.pe/service/MPO/AtencionCliente/tarjeta.consultarRiesgo/v1.0/");
		headerRiesgo.put("Host", "dpiuat.grupoib.local:7200");
		headerRiesgo.put("Content-Type", "text/xml");
		
																	
		SerenityRest.given().headers(headerRiesgo).and().and().body(finalfileInputStream).when()
	...
	@When("^cliente consulta sus listado distribuciones$")
	public void cliente_consulta_sus_millas_benefit_con_su_de_debito_o_credito_de(String tarjeta, String arg2,
			String arg3) throws Throwable {

		ActionEjecutarServicioAndAPI.ActionEjecutarAPIDistribuciones();
	}	
